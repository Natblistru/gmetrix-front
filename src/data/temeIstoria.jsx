let temeIstoria = [
  {
    id: "1",
    title: "Primul Război Mondial și formarea statului național român",
    disciplina: "Istoria",
    ...
    subtitles: [
      {
        ...
        breadcrumb: [{name:"Discipline",path: "/"},{name:"Istoria",path:"/teme-istoria"}],
        subjects: [
          {
            id: "1",
            ...
            breadcrumb: [{name:"Discipline",path: "/"},
                         {name:"Istoria",path:"/teme-istoria"},
                         {name:"România în Primul Război Mondial",path:"/tema1"}],
            vomAfla: [{name:"Vom afla 1",id: "1"},
                      {name:"Vom afla 2",id: "2"},
                      {name:"Vom afla 3",id: "3"}],
            innerHTML:
  ...
  {
    id: "2",
    title: "Lumea în perioada interbelică",
    disciplina: "Istoria",
    ciclul: "Ciclul gimnazial",
    subtitles: [
  ...
  {
    id: "3",
    title: "Relațiile internaționale în perioada interbelică",
    disciplina: "Istoria",
    ciclul: "Ciclul gimnazial",
    subtitles: [
  ...
  {
    id: "6",
    title: "Lumea la sfârșitul secolului XX - începutul secolului XXI",
    disciplina: "Istoria",
    ciclul: "Ciclul gimnazial",
    subtitles: [
      {
  ...
  {
    id: "7",
    title: "Cultura și știința în perioada postbelică",
    disciplina: "Istoria",
    ciclul: "Ciclul gimnazial",
    subtitles: [
