            ...
            <div className="col-md-3">
              <div className="form-group">
                ...
                <input
                  ...
                  name="column3"
                  onChange={(event) => handleInputTest(activeTab, null, event)}
                  value={content[activeTab].column3}
                  className="form-control"
                />
                <span style={{ color: 'red', fontSize: '0.8rem' }}>{errorList.column3}</span>
              </div>
            </div>
          </div>  
            ...
            <div className="col-md-1 align-self-start" >
              <div className="form-group">
                ...
                <input
                  ...
                  name="correct1"
                  onChange={event => handleInputTest(activeTab, index, event)}
                  defaultChecked={row.correct1 == 1 ? true: false}
                  style={{ marginTop: '15px', marginLeft: '15px' }}
                />
              </div>
            </div>
...
function MyTestDnDGroup({ tabs, addTab, removeTab, onRemoveTab, activeTab, onTabClick, tabContent, handleInputTest, handleRemoveTestRow, handleAddTestRow, errorList, testComplexityList, editorStates, setEditorStates, pictures, setPictures }) {
  return (
    <>
      <TabList
        tabs={tabs}
